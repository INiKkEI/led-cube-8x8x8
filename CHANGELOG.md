...
Add a new entry only when a major milestone is reached, for example:
- hardware architecture freeze
- PCB design release
- first assembled hardware
- firmware bring-up completed
- first full-cube demo
- validation/release milestone
